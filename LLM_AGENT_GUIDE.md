...
**Tests:**
- [server/__tests__/](server/__tests__/) - Vitest tests for all server modules (36 test files)
...
- Run `npm test` before committing changes (all tests across 36 files should pass)
