...
export function validateGameType(gameType) {
    ...
    const allowed = ['maexchen', 'lobby', 'watchparty', 'stocks', 'strictbrain', 'lol-betting', 'loop-machine', 'strict-club', 'shop', 'strictly7s', 'tierlist', 'casino', 'plinko', 'crash', 'achievements', 'blackjack', 'roulette'];
